...
class AuthersControllerTest < ActionController::TestCase
  ...
  test "should create auther" do
    assert_difference('Auther.count') do
      post :create, auther: { email: @auther.email, password: @auther.password, password_confirmation: @auther.password_confirmation, string: @auther.string, username: @auther.username }
    end
  ...
  test "should update auther" do
    patch :update, id: @auther, auther: { email: @auther.email, password: @auther.password, password_confirmation: @auther.password_confirmation, string: @auther.string, username: @auther.username }
    assert_redirected_to auther_path(assigns(:auther))
  end
